    ...
    return (
        <div className='flex flex-col w-full'>
            ...
            <div className='flex-grow mt-2'>
                ...
                className={`w-full py-3 px-3 rounded-lg bg-accent-blue text-slate-400 text-sm border-[1px] disabled:border-slate-400 focus:outline-none ${valid ? 'border-transparent focus:border-primary-blue' : 'border-primary-red focus:border-primary-red'}`}
